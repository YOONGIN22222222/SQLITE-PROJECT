...
public class DQLService {
    ...
    public void printMapList(List<Map<String, Object>> mapList) {
        ...
        // 상세 데이터 출력
        System.out.println("No Name Kor Eng Math Scien Sum Avg Grade RegDate");
        System.out.println("==================================================");
        ...
        for(int i = 0; i < mapList.size(); i++) {
            ...
            System.out.println(id + ". " + name + "  " + kor_score + "  " + eng_score + "  " + math_score + "  " + scien_score + "  "+sum + " " + avg + "  " + grade + "  " + reg_date);
        }
    }
}